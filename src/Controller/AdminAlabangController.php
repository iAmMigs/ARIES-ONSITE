...
{
    // Mock Data Simulator - Updated with dataF.pdf BED fields
    private function getRegistrations(): array
    {
        return [
            1 => [
                ...
                'exam_score' => null,
                'exam_date' => null,
                'adcon_number' => 'AD-2026-001', // Admission Control No.
                ...
                'documents' => [
                    'psa' => 'psa_osinada.pdf',
                    'card' => 'form138_osinada.jpg',
                    'moral' => 'good_moral.jpg'
                ]
            ],
            2 => [
                'id' => 2,
                ...
                'father_deceased' => true, // Example Deceased
                'father_ofw' => false,
